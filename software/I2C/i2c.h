...
#define I2C0_BASE_ADDRESS 0x11400
...
int* i2c_control = (const int *) I2C_CONTROL;  //s1
int* i2c_data    = (const int *) I2C_DATA; //s0
int* i2c_status  = (const int *) I2C_STATUS;  //s1 row 2
int* i2c_prescale = (const int *) I2C_PRESCALE; //s2_1
int* i2c_scl = (const int *) I2C_SCL; //s2_2
int* i2c_led = (const int *) I2C_TESTLED; //dummy
#else
