...
//	playFirst();
    ...
    WriteIntoUart(UART_DATA_REGISTER, UART1, 'G') ;
    WriteIntoUart(UART_DATA_REGISTER, UART1, '2') ;
    WriteIntoUart(UART_DATA_REGISTER, UART1, '8') ;
    WriteIntoUart(UART_DATA_REGISTER, UART1, ' ') ;
    WriteIntoUart(UART_DATA_REGISTER, UART1, 'X') ;
//    sleep(30);
//    StopPlay();
